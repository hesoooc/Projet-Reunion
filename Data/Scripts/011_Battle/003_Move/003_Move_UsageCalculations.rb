class Battle::Move
  ...
  def pbCalcTypeModSingle(moveType, defType, user, target)
	...
	# Beta Phase
    if target.hasActiveAbility?(:BETAPHASE) && ret != Effectiveness::INEFFECTIVE
      if ret != Effectiveness::NORMAL_EFFECTIVE_ONE
        @battle.pbShowAbilitySplash(target)
        @battle.pbDisplay(_INTL("Les faiblesses et résistances sont annulées !", target.pbThis))
